...
namespace UnityEngine.XR.ARFoundation.Samples
{
	...
	public class AR_PrefabImagePairManager : MonoBehaviour, ISerializationCallbackReceiver
	{
		/// <summary>
		...
		class PrefabImagePairManagerInspector : Editor
		{
			...
			public override void OnInspectorGUI()
			{
				...
				var behaviour = serializedObject.targetObject as AR_PrefabImagePairManager;
